        ...
        a = elementorModules.frontend.handlers.Base.extend({
          ...
          getDefaultSettings() {
            const e = this.getElementSettings('rotate_iteration_delay'),
              t = {
                animationDelay: (e || 2500) / 3,
                lettersDelay: (0.02 * e || 50) / 3,
                typeLettersDelay: (0.06 * e || 150) / 3,
                selectionDuration: (0.2 * e || 500) / 3,
                revealDuration: (0.24 * e || 600) / 3,
                revealAnimationDelay: (0.6 * e || 1500) / 3,
            ...
            console.log('getDefaultSettings t:', t);
            return (
